...
Namespace ServiceReference2
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="ServiceReference2.CalculadoraSoap")>  _
    ...
    Public Interface CalculadoraSoapChannel
        Inherits ServiceReference2.CalculadoraSoap, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class CalculadoraSoapClient
        Inherits System.ServiceModel.ClientBase(Of ServiceReference2.CalculadoraSoap)
        Implements ServiceReference2.CalculadoraSoap
        ...
        Public Function Suma(ByVal nro1 As Double, ByVal nro2 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Suma
            Return MyBase.Channel.Suma(nro1, nro2)
        End Function
        
        Public Function SumaAsync(ByVal nro1 As Double, ByVal nro2 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.SumaAsync
            Return MyBase.Channel.SumaAsync(nro1, nro2)
        End Function
        
        Public Function Resta(ByVal nro1 As Double, ByVal nro2 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Resta
            Return MyBase.Channel.Resta(nro1, nro2)
        End Function
        
        Public Function RestaAsync(ByVal nro1 As Double, ByVal nro2 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.RestaAsync
            Return MyBase.Channel.RestaAsync(nro1, nro2)
        End Function
        
        Public Function Multiplicacion(ByVal nro1 As Double, ByVal nro2 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Multiplicacion
            Return MyBase.Channel.Multiplicacion(nro1, nro2)
        End Function
        
        Public Function MultiplicacionAsync(ByVal nro1 As Double, ByVal nro2 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.MultiplicacionAsync
            Return MyBase.Channel.MultiplicacionAsync(nro1, nro2)
        End Function
        
        Public Function Division(ByVal nro1 As Double, ByVal nro2 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Division
            Return MyBase.Channel.Division(nro1, nro2)
        End Function
        
        Public Function DivisionAsync(ByVal nro1 As Double, ByVal nro2 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.DivisionAsync
            Return MyBase.Channel.DivisionAsync(nro1, nro2)
        End Function
        
        Public Function Factorial(ByVal n As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Factorial
            Return MyBase.Channel.Factorial(n)
        End Function
        
        Public Function FactorialAsync(ByVal n As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.FactorialAsync
            Return MyBase.Channel.FactorialAsync(n)
        End Function
        
        Public Function Potencia(ByVal nro1 As Integer, ByVal nro2 As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Potencia
            Return MyBase.Channel.Potencia(nro1, nro2)
        End Function
        
        Public Function PotenciaAsync(ByVal nro1 As Integer, ByVal nro2 As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.PotenciaAsync
            Return MyBase.Channel.PotenciaAsync(nro1, nro2)
        End Function
        
        Public Function Tangente(ByVal nro As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Tangente
            Return MyBase.Channel.Tangente(nro)
        End Function
        
        Public Function TangenteAsync(ByVal nro As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.TangenteAsync
            Return MyBase.Channel.TangenteAsync(nro)
        End Function
        
        Public Function Coseno(ByVal nro As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Coseno
            Return MyBase.Channel.Coseno(nro)
        End Function
        
        Public Function CosenoAsync(ByVal nro As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.CosenoAsync
            Return MyBase.Channel.CosenoAsync(nro)
        End Function
        
        Public Function Seno(ByVal nro As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Seno
            Return MyBase.Channel.Seno(nro)
        End Function
        
        Public Function SenoAsync(ByVal nro As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.SenoAsync
            Return MyBase.Channel.SenoAsync(nro)
        End Function
        
        Public Function Inverso(ByVal nro1 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Inverso
            Return MyBase.Channel.Inverso(nro1)
        End Function
        
        Public Function InversoAsync(ByVal nro1 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.InversoAsync
            Return MyBase.Channel.InversoAsync(nro1)
        End Function
        
        Public Function Porcentaje(ByVal nro1 As Double, ByVal nro2 As Double) As Double Implements ServiceReference2.CalculadoraSoap.Porcentaje
            Return MyBase.Channel.Porcentaje(nro1, nro2)
        End Function
        
        Public Function PorcentajeAsync(ByVal nro1 As Double, ByVal nro2 As Double) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.PorcentajeAsync
            Return MyBase.Channel.PorcentajeAsync(nro1, nro2)
        End Function
        
        Public Function Logaritmo(ByVal nro As Integer) As Double Implements ServiceReference2.CalculadoraSoap.Logaritmo
            Return MyBase.Channel.Logaritmo(nro)
        End Function
        
        Public Function LogaritmoAsync(ByVal nro As Integer) As System.Threading.Tasks.Task(Of Double) Implements ServiceReference2.CalculadoraSoap.LogaritmoAsync
